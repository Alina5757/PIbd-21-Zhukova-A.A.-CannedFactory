...
namespace CannedFactoryView
{
    public partial class FormReportOrders : Form
    {
        ...
        private void buttonCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Дата начала должна быть меньше даты оконания", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            try
            {
                ...
                var parameters = new[] {new ReportParameter("ReportParameterPeriod", "с " +
